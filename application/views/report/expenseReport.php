...
<section class="content-header">
    <h3  style="text-align: center;margin-top: 0px"><?php echo lang('expense_report'); ?></h3>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <select tabindex="2" class="form-control select2" id="expense_item_id" name="expense_item_id" style="width: 100%;">
                    <option value=""><?php echo lang('expense_item'); ?></option>
                    <?php
                    foreach ($expense_items as $value) {
                        ?>
                        <option value="<?php echo $value->id ?>" <?php echo set_select('expense_item_id', $value->id); ?>><?php echo $value->name ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <h3><?php echo lang('expense_report'); ?></h3>
                    ...
                    if (isset($expense_item_id) && $expense_item_id):
                        echo lang('expense_item').": <span style='text-decoration: underline'>" . userName($expense_item_id) . "</span>";
                    else:
...
<script>  
    ...
    var TITLE = "<?php echo lang('expense_report'); ?> "+today; 
