<?php 
    ...
    if(isset($register_info) && count($register_info)>0){
        ...
        foreach($register_info as $single_register_info){
            ...
            // echo "</pre>";
            $cash = is_null($payment_methods_sale)?'Cash: 0.00':'Cash: '.$payment_methods_sale->Cash;
            $paypal = is_null($payment_methods_sale)?'Paypal: 0.00':'Paypal: '.$payment_methods_sale->Paypal;
            $card = is_null($payment_methods_sale)?'Card: 0.00':'Card: '.$payment_methods_sale->Card;
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="title" style="width: 10%">Opening Date & Time</th>
                                <th class="title" style="width: 15%">Opening Balance</th>
                                <th class="title" style="width: 15%">Sale (Paid Amount)</th>
                                <th class="title" style="width: 15%">Customer Due Receive</th>
                                <th class="title" style="width: 10%">Closing Date & Time</th>
                                <th class="title" style="width: 15%">Closing Balance</th>
                                <th class="title" style="width: 15%">Sale In Payment Methods</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
