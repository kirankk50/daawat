            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-striped" id="datatable">
                        ...
                        <tr>
                            <td style="width: 40%;">Purchase(Only Paid Amount)</td> 
                        ...
                        <tr>
                            ...
                            <td><?= isset($saleReportByDate['customer_due_receive']) ? $saleReportByDate['customer_due_receive'] : '0.0' ?></td>
                        </tr>
                        <tr>
                            <td>Waste</td> 
                        ...
                        <tr>
                            <td style="width: 80%;">Gross Profit = ((Sale + Customer Due Receive) - (Purchase + Waste + Expense + Supplier Due Payment))</td>
                            <td style="width: 20%;"><?= isset($saleReportByDate['gross_profit']) ? number_format($saleReportByDate['gross_profit'], 2) : '0.0' ?></td>
                        </tr>
                        <tr>
                            <td style="width: 80%;">Net Profit = ((Sale + Customer Due Receive) - (Purchase + Waste + Expense + Supplier Due Payment) - VAT))</td>
