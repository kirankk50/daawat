...
<section class="content-header">
    <h3  style="text-align: center;margin-top: 0px"><?php echo lang('customer_report'); ?></h3>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <select tabindex="2" class="form-control select2"  id="customer_id" name="customer_id" style="width: 100%;">
                    <option value=""><?php echo lang('customers'); ?></option>
                    <?php
                    foreach ($customers as $value) {
                        ?>
                        <option value="<?php echo $value->id ?>" <?php echo set_select('customer_id', $value->id); ?>><?php echo $value->name ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="alert alert-error error-msg customer_id_err_msg_contnr" style="padding: 5px !important;">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    ...
                    if (isset($customer_id) && $customer_id):
                        echo "<span>" . getCustomerName($customer_id) . "</span>";
                    endif;
                    ?></h4>
                    ...
                    <br>
                    <h4 style="text-align: left;margin-bottom: 10px"><?php echo lang('sale'); ?></h4>
                    ...
                    <br>
                    <h4 style="text-align: left;margin-bottom: 10px"><?php echo lang('due_receive'); ?></h4>
                    <table class="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th style="width: 2%;text-align: center"><?php echo lang('sn'); ?></th>
...
<script>  
    ...
    var TITLE = "<?php echo lang('customer_ledger_report'); ?> "+today; 
