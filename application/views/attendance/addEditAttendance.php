                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4"> 
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="date" readonly name="<?php echo lang('date'); ?>" class="form-control" placeholder="Date" value="<?php if($encrypted_id == ''){ echo set_value('date'); }else{ echo $attendance_details->date; }?>">
                            </div>
