                    ...
                    <div class="col-sm-6">
                        <div class="form-group" style="margin-bottom: 2px;">
                            ...
                            <select id="payment_method_id" name="payment_method_id" class="form-control custom-selected" style="width: 100%">
                                <?php
                                $methods = $this->db->query("SELECT * FROM tbl_payment_methods 
    ...
    <div class="modal-dialog" role="ShortCut">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-2x">×</i></span></button>
                <h4 class="modal-title" id="myModalLabel"><i style="color:#3c8dbc" class="fa fa-keyboard-o"></i> Shortcut Keys</h4>
            </div>
            <div class="modal-body">
                <table class="table">
                    <tr>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control customDatepicker" id="customerDateOfBirth" name="date_of_birth" placeholder="Date Of Birth" value="">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-4 control-label">Date Of Anniversary</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control customDatepicker" id="customerDateOfAnniversary" name="date_of_anniversary" placeholder="Date Of Anniversary" value="">
                        </div>
                    </div>
