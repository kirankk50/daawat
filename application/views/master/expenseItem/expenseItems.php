...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-2">
            <a href="<?php echo base_url() ?>Master/addEditExpenseItem"><button type="button" class="btn btn-block btn-primary pull-right"><?php echo lang('add_expense_item'); ?></button></a>
        </div>
    </div> 
</section>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                                <li><a href="<?php echo base_url() ?>Master/addEditExpenseItem/<?php echo $this->custom->encrypt_decrypt($ei->id, 'encrypt'); ?>" ><i class="fa fa-pencil tiny-icon"></i><?php echo lang('edit'); ?></a></li>
                                                <li><a class="delete" href="<?php echo base_url() ?>Master/deleteExpenseItem/<?php echo $this->custom->encrypt_decrypt($ei->id, 'encrypt'); ?>" ><i class="fa fa-trash tiny-icon"></i><?php echo lang('delete'); ?></a></li> 
                                            </ul> 
                                        </div>
                                    </td>
                                </tr>
