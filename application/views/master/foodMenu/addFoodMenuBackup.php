...
?>;  
        ...
        $("#food_menu_form").submit(function(){
            ...
            if(veg_item==""){ 
                $("#veg_item_err_msg").text("The Is it Veg Item? field is required.");
                $(".veg_item_err_msg_contnr").show(200);
                error = true;
            } 
            
            if(beverage_item==""){ 
                $("#beverage_item_err_msg").text("The Is it Beverage? field is required.");
                $(".beverage_item_err_msg_contnr").show(200);
                error = true;
            } 
            
            if(bar_item==""){ 
                $("#bar_item_err_msg").text("The Is it Bar Item? field is required.");
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="name" name="name" class="form-control" placeholder="Name" value="<?php echo set_value('name'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Code</label>
                                <input tabindex="6" type="text" name="code" class="form-control" placeholder="Code" value="<?= $autoCode ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td><input tabindex="4" type="text"  onfocus="this.select();" id="sale_price" name="sale_price" class="form-control integerchk" onkeyup="return replacePonto();" placeholder="Sale Price" value="<?php echo set_value('sale_price'); ?>"></td>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="description" name="description" class="form-control" placeholder="Description" value="<?php echo set_value('description'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select tabindex="2" class="form-control select2" id="veg_item" name="veg_item" style="width: 100%;">
                                    <option value="">Select</option>
                                    <option value="Veg No">No</option>
                                    <option value="Veg Yes">Yes</option> 
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select tabindex="2" class="form-control select2" id="beverage_item" name="beverage_item" style="width: 100%;">
                                    <option value="">Select</option>
                                    <option value="Beverage No">No</option>
                                    <option value="Beverage Yes">Yes</option> 
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select tabindex="2" class="form-control select2" id="bar_item" name="bar_item" style="width: 100%;">
                                    <option value="">Select</option>
                                    <option value="Bar No">No</option>
                                    <option value="Bar Yes">Yes</option> 
                                </select>
                            </div>
