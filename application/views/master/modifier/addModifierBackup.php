...
?>;  
        ...
        $("#food_menu_form").submit(function(){
            ...
            if(price==""){
                $("#price_err_msg").text("The Price field is required.");
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <?php echo form_open(base_url() . 'Master/addEditModifier', $arrayName = array('id' => 'food_menu_form', 'enctype' => 'multipart/form-data')) ?>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="4" type="text"  onfocus="this.select();" id="price" name="price" class="form-control integerchk" placeholder="Price" value="<?php echo set_value('price'); ?>"> 
                            </div>
                            ...
                            <?php } ?>
                            <div class="alert alert-error error-msg price_err_msg_contnr" style="padding: 5px !important;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea tabindex="3" class="form-control" rows="2" id="description" name="description" placeholder="Enter ..."><?php echo $this->input->post('description'); ?></textarea>
                            </div>
