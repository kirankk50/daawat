                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input  tabindex="4" type="text" id="date"  name="date_of_birth" class="form-control datepicker" placeholder="Date Of Birth" value="">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="5" type="text" id="dates2" name="date_of_anniversary" class="form-control " placeholder="Date Of Anniversary" value="">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Address</label>
                                <textarea tabindex="6" name="address" class="form-control" placeholder="Address"></textarea>
                            </div>
                        </div>
