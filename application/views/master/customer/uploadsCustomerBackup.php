    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary"> 
                <!-- form start -->
                <?php echo form_open_multipart(base_url('Master/ExcelDataAddCustomers')); ?>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url() ?>Master/downloadPDF/Customer_Upload.xlsx">
