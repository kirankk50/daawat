                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="name" class="form-control" placeholder="Table Name" value="<?php echo set_value('name'); ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Seat Capacity <span class="required_star">*</span></label>
                                <input tabindex="2" type="text" name="sit_capacity" class="form-control integerchk" placeholder="Seat Capacity" value="<?php echo set_value('sit_capacity'); ?>">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="position" class="form-control" placeholder="Position" value="<?php echo set_value('position'); ?>">
                            </div>
                            ...
                            <div class="form-group"> 
                                ...
                                <select tabindex="2" class="form-control select2" name="outlet_id" style="width: 100%;">
                                    ...
                                    <?php foreach ($outlets as $outlet) { ?>
                                        <option value="<?php echo $outlet->id ?>" <?php echo set_select('outlet_id', $outlet->id); ?>><?php echo $outlet->outlet_name ?></option>
                                    <?php } ?>
                                </select>
                            </div> 
