        ...
        $('#ingredient_id').change(function(){ 
            ...
            if (ingredient_details != '') { 
                ...
                var cart_row = '<tr class="rowCount" data-id="' + suffix + '" id="row_' + suffix + '">'+
                    ...
                    '<td style="width: 15%"><input type="text" data-countID="'+suffix+'" id="consumption_amount_' + suffix + '" name="consumption_amount[]" onfocus="this.select();" class="form-control integerchk aligning" placeholder="Consumption Amt" onkeyup="return calculateAll();"/><span class="label_aligning"> ' + ingredient_details_array[2] + '</span></td>'+
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="3" type="text" id="date" name="date" class="form-control" placeholder="Date" readonly value="<?php echo date('Y-m-d', strtotime($inventory_adjustment_details->date)); ?>">
                            </div>
...
<?php } ?> 
                    ...
                    <div class="row">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="20%">Consumption Status</th>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Note</label>
                                <textarea tabindex="3" class="form-control" rows="2" id="note" name="note" placeholder="Enter ..."><?php echo $inventory_adjustment_details->note; ?></textarea>
                            </div>
...
<?php } ?>
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo base_url() ?>Inventory_adjustment/inventoryAdjustments"><button type="button" class="btn btn-primary">Back</button></a>
                </div>
<?php echo form_close(); ?> 
            </div> 
        </div>
