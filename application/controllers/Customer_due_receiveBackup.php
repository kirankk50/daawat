...
class Customer_due_receive extends CI_Controller {
    ...
    public function addCustomerDueReceive() {
        ...
        if ($this->input->post('submit')) {
            ...
            $this->form_validation->set_rules('customer_id', 'Customer', 'required|max_length[10]');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $splr_payment_info['reference_no'] = $this->input->post($this->security->xss_clean('reference_no'));
                $splr_payment_info['customer_id'] = $this->input->post($this->security->xss_clean('customer_id'));
